...
namespace Mobillogix\Launchpad\JobsBundle\DependencyInjection;
...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode = $treeBuilder->root('mobillogix_launchpad_jobs');

        $types = $rootNode->children()
                ->scalarNode("template")->defaultValue("MobillogixLaunchpadJobsBundle::base.html.twig")->end()
