...
namespace Mobillogix\Launchpad\JobsBundle\Service\Persistence;
...
class JobPersistenceService
{
    ...
    const PARENT_JOB_CLASS = 'Mobillogix\Launchpad\JobsBundle\Model\BaseJob';
    ...
    function __construct(EntityManager $em, $config)
    {
        ...
        $this->jobTypeRepository = $em->getRepository('MobillogixLaunchpadJobsBundle:JobType');
        $this->jobRepository = $em->getRepository('MobillogixLaunchpadJobsBundle:Job');
        $this->jobEventRepository = $em->getRepository('MobillogixLaunchpadJobsBundle:JobEvent');
    }
