 ...
 * @ORM\Entity(repositoryClass="Mobillogix\Launchpad\JobsBundle\Repository\JobEventRepository")
 */
class JobEvent
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Mobillogix\Launchpad\JobsBundle\Entity\Job", inversedBy="events")
     */
    protected $job;

    /**
     * @ORM\ManyToOne(targetEntity="Mobillogix\Launchpad\JobsBundle\Entity\JobPackage")
