...
class JobProcessPersistenceServiceTest extends BaseJobsTestCase
{
    ...
    public function testShouldAddPackage()
    {
        ...
        $em = $this->getEntityManagerMock([
            'MobillogixJobsBundle:JobPackage' => $packageRepository,
        ]);
     ...
     * @expectedExceptionMessage Job process class 'Mobillogix\JobsBundle\Tests\Process\JobProcessPersistenceServiceTest' must be subclass of Mobillogix\JobsBundle\Model\BaseProcess
     */
    ...
    public function testShouldGetProcessesToRun()
    {
        ...
        $config = ['types' => []];
        $config['types']['test'] = [
            'process_class' => 'Mobillogix\JobsBundle\Tests\Stub\StubProcess',
            'packages_chunk' => 10,
        ];
        $service = new JobProcessPersistenceService($em, $config);
    ...
    public function testShouldMarkProcessStarted()
    {
        ...
        $em = $this->getEntityManagerMock([
            'MobillogixJobsBundle:JobPackage' => $packageRepository,
            'MobillogixJobsBundle:JobEvent' => $eventRepository,
        ]);
