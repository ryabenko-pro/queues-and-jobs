...
namespace Mobillogix\JobsBundle\DependencyInjection;
...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode = $treeBuilder->root('mobillogix_jobs');

        $types = $rootNode->children()
                ->scalarNode("template")->defaultValue("MobillogixJobsBundle::base.html.twig")->end()
