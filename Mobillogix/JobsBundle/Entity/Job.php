...
/**
 * @ORM\Table(name="job")
 * @ORM\Entity(repositoryClass="Mobillogix\JobsBundle\Repository\JobRepository")
 */
class Job
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Mobillogix\JobsBundle\Entity\JobType")
     * @ORM\JoinColumn(name="job_type_id")
     */
    protected $jobType;

    /**
     * @ORM\OneToMany(targetEntity="Mobillogix\JobsBundle\Entity\JobPackage", mappedBy="job")
     */
    protected $packages;

    /**
     * @var JobEvent[]|ArrayCollection
     * @ORM\OneToMany(targetEntity="Mobillogix\JobsBundle\Entity\JobEvent", mappedBy="job")
     */
    protected $events;
