 ...
 * @ORM\Entity(repositoryClass="Mobillogix\JobsBundle\Repository\JobPackageRepository")
 */
class JobPackage
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Mobillogix\JobsBundle\Entity\Job", inversedBy="packages")
     */
    protected $job;
